...
var WeatherApp = /** @class */ (function () {
    function WeatherApp(element) {
        ...
        this.cities = this.cities.map(function (c) { return new City(c.name, _this); });
        this.render();
    }
    WeatherApp.prototype.addCity = function (c) {
        this.cities.push(c);
        this.render();
        this.saveIntoStorage();
    };
    WeatherApp.prototype.removeCity = function (c) {
        this.cities = this.cities.filter(function (city) { return city.name !== c.name; }); //pierwsze city to parametr funkcji => return
...
var modal = document.querySelector('#addCityModal');
var bootstrapModal = new bootstrap.Modal(modal, {
    keyboard: false
});
var input = document.querySelector('#cityName');
var saveBtn = document.querySelector('#saveCity');
...
function addCity() {
    var city = new City(input.value, app);
    app.addCity(city);
    bootstrapModal.hide();
    input.value = '';
}
